                    ...
                    {staffUsers.map(user => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between text-[9px] text-slate-400">
                          <span className="font-mono text-emerald-400 font-semibold">@{user.username}</span>
                          <span className={`px-1 py-0.2 rounded text-[7px] font-bold border ${
                            user.role === 'ADMIN' ? 'bg-amber-950/80 text-amber-300 border-amber-800' : 'bg-emerald-950/80 text-emerald-300 border-emerald-800'
                          }`}>
                            {user.role}
                          </span>
                        </div>
